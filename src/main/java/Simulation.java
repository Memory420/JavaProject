...
public class Simulation extends Application {
            ...
            for (int j = 0; j < col; j++) {
                ...
                button.setOnAction(e -> {
                    if (cell.getEntity() == null) {
                        ...
                        Tree tree = new Tree(cell, age);
                        button.setText(String.valueOf(age));
    ...
    void startTicks() {
        Timeline timeline = new Timeline(new KeyFrame(Duration.millis(500), e -> tick()));
